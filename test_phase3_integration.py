...
from vitruvyan_core.domains.finance_aggregation_provider import FinanceAggregationProvider
...
def test_complete_phase3_integration():
    ...
    explain_provider = FinanceExplainabilityProvider()
    risk_provider = FinanceRiskProvider()
    aggregation_provider = FinanceAggregationProvider()
