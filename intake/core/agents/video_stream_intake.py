...
# Add parent path for guardrails import
...
class VideoStreamIntakeAgent:
    ...
    - Emit intake.evidence.created events
    ...
    def _extract_frames(self, cap: cv2.VideoCapture, fps: float, interval_sec: float, keyframes_only: bool) -> List[Dict]:
        """
        Extract frames according to sampling policy
