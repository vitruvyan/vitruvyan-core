...
from core.cognitive_bus.consumers.base_consumer import (
    BaseConsumer,
    ConsumerConfig,
    ConsumerType,
    ProcessResult
)
from core.cognitive_bus.transport.streams import StreamEvent
from core.cognitive_bus.events.event_envelope import CognitiveEvent, TransportEvent, EventAdapter
from core.cognitive_bus.consumers.working_memory import WorkingMemory
