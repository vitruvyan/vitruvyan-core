...
✅ Emit `intake.evidence.created` events to Redis Cognitive Bus  
...
**MUST DO**:
✅ Consume `intake.evidence.created` events from Redis Cognitive Bus  
...
## Event Contract: `intake.evidence.created`

**Event Schema**: `aegis://intake/events/evidence_created/v1.0`  
**Channel**: `intake.evidence.created` (Redis Streams)  
...
7. [INTAKE] Emit event to Redis: intake.evidence.created
...
- [ ] Events have `schema_ref` = `aegis://intake/events/evidence_created/v1.0`
