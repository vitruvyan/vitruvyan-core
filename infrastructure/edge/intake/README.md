...
```bash
psql -h <POSTGRES_HOST> -U <POSTGRES_USER> -d vitruvyan_core -f infrastructure/edge/intake/core/schema.sql
```
...
```bash
docker build -f infrastructure/edge/intake/service/Dockerfile -t aegis_intake:latest .
```
...
- Containerized run (recommended): keep Intake on `vitruvyan_core_net` and use
...
- **Core README**: [infrastructure/edge/intake/core/README.md](core/README.md)
- **Compliance Checklist**: [infrastructure/edge/intake/core/COMPLIANCE_CHECKLIST.md](core/COMPLIANCE_CHECKLIST.md)
- **Codex Contract**: [infrastructure/edge/intake/core/INTAKE_CODEX_BOUNDARY_CONTRACT.md](core/INTAKE_CODEX_BOUNDARY_CONTRACT.md)
